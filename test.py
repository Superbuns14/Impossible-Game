# Jeffrey Zhou and Aiyu Kamate
# in this game, we have a simple graphic. When the user enters the area in 450 < X < 600 and 250 < Y < 400,
# the combat starts. The computer will always shoot fire towards the user, so the user needs to dodge and kill the
# computer by shooting bullets. Very skill based!
# we will add quests/ more combats/ levels etc to this for our final.
