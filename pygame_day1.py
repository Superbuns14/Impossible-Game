...
# This is a adventure game, in which the player will fight in quests to level up, and will fight the final boss in order to win! There is also a stats building to check your stats, and the inn, where you can check the tutorial again.
# The game started off with a very basic combat system where you were fighting monsters with a very basic attacking system. From here, we evolved the combat system to make it much more skill demanding to play. Then we also made a variety of monsters all with different attacking systems. In between creating the monsters, we made several foundations for the entire game. For example, we made boundaries for all the house walls, which doors you have to enter to go to the next quest, a house to see your stats, to relook at the tutorial and so on. In addition, we changed the bulllet from only moving upwards, to being able to be aimed through the use of your mouse.
# Aiyu: I was very proud of the boundaries I made in the map. This was hard because I had to think about the player size, but I managed to make it perfectly in the end. I am also proud of making the combat system against the baby skulls and the boss skulls, and I am happy that the battle system is skill based.
# Jeffrey: One thing that I was very proud of was the bullet aiming system. Before I tweaked it, the bullet could only go upwards, but now it goes in the direction of the mouse. I addition, I was also quite proud of several of the quests and the monsters that I made. They were all quite unique and difficult to do. Both of us were also very proud of our graphics. They took several hours to implement.
...
# Peer comments
# PJ: change movement from 4 arrow keys to w,a,s, and d so user experience will become better. Add tutorial so that users know what they need to do in the game.
# Justin: change bullet to energy ball. Also, you could try pixelating images to make graphics consistent.
